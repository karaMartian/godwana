...
public class CompiledModel implements Comparable<CompiledModel> {
    ...
    @Override
    public int compareTo(CompiledModel s) {
        return product.compareTo(s.getProduct());
    }
    
    @Override
    public boolean equals(Object aCompiledModedl) {
    	CompiledModel s = (CompiledModel) aCompiledModedl;
